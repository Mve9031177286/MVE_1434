...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("У меня две бабушки: бабушка "+gosha.getMother().getMother().getName()+" и "
                +gosha.getFather().getMother().getName());
        System.out.println("У меня два дедушки: дедушка "+gosha.getFather().getFather().getName()+" и "
